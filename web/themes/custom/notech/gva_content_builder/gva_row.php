		...
		global $base_url, $base_path;
         ...
         $array_class[]	= $class;
			...
			if( $bg_image){
				...
				else if($bg_size == '300px'){
					$array_style[]  = 'background-size: 300px';
				}
				else if($bg_size == '500px'){
					$array_style[]  = 'background-size: 500px';
				}
				else if($bg_size == '700px'){
					$array_style[]  = 'background-size: 700px';
				}
