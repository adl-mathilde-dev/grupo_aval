...
if (!class_exists('element_gva_adl_card_banks')):
   class element_gva_adl_card_banks
   {
...
?>
         <div class="adl-card-bank_products <?php print($el_class) ?>">
            ...
            <div class="adl-card-bank_products-main adl-card-banks">
               <div class="row">
                  <?php for ($i = 1; $i <= 10; $i++) { ?>
                     <?php
                     $id_tag = "id_tag_{$i}";
                     ...
                     ?>
                     <?php if ($$image_e) { ?>
                        <div id="<?php print($$id_tag) ?>" class="adl-card-bank_products-body-item col">
                           <div>
